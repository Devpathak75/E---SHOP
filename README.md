...
Step 2: Click On File > Import > Git > Projects From Git > Clone Uri > Paste The Repository Url as: ```https://github.com/Devpathak75/E---SHOP.git```> Select master Branch > Next > Next > Finish.
